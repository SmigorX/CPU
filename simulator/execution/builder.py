...
def _r_type_instruction_split(
    instruction_subop: RTypeSuboperands, instruction_data: int
) -> RTypeInstruction:
...
def _i_type_instruction_split(
    instruction_subop: ITypeSuboperands, instruction_data: int
) -> ITypeInstruction:
...
def _b_type_instruction_split(
    instruction_subop: BTypeSuboperands, instruction_data: int
) -> BTypeInstruction:
    return BTypeInstruction(instruction_subop, instruction_data)


def _j_type_instruction_split(
    instruction_subop: JTypeSuboperands, instruction_data: int
) -> JTypeInstruction:
